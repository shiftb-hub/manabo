...
// ===== 型定義（no-explicit-any 排除） =====
type TooltipItem = {
  value?: number | string | null
  name?: string
  color?: string
  dataKey?: string
  // Recharts の raw payload（系列元データ1点分）
...
function getPayloadConfigFromPayload(
  ...
  return (
    configLabelKey in config ? config[configLabelKey] : config[key as keyof typeof config]
  ) as ChartConfig[keyof ChartConfig] | undefined
}
