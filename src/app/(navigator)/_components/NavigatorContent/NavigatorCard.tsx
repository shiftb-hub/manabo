...
export const NavigatorCard = ({ screen }: Props) => {
  ...
  return (
    <Link href={screen.href} className='block' aria-label={`${screen.title}画面に移動`}>
        ...
        <CardContent className='p-4'>
          <div className='flex items-start space-x-4'>
            ...
            <div className='flex-1 min-w-0'>
              <h3 className='text-lg font-bold text-gray-800 mb-1'>{screen.title}</h3>
              <p className='text-sm text-gray-600 mb-2 sm:mb-3'>{screen.description}</p>
