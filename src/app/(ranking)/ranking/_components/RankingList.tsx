...
import { useStreak } from '@/app/(dashboard)/dashboard/_hooks/useStreak'
import { Avatar, AvatarFallback, AvatarImage } from '@/app/_components/ui/avatar'
import { Badge } from '@/app/_components/ui/badge'
import { Card, CardContent, CardHeader, CardTitle } from '@/app/_components/ui/card'

import type { RankingPeriod, RankingUser } from '../_types/rankingTypes'
import { getChangeColor, getPeriodLabel, getRankIcon } from '../_utils/rankingUtils'
...
export function RankingList({ users, period }: RankingListProps) {
  ...
  // 現在ログイン中ユーザーの最新 streak を取得（他ユーザーはサーバーから来た値をそのまま使う）
